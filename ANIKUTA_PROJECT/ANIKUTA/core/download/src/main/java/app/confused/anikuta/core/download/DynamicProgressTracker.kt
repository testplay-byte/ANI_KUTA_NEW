    ...
    fun compute(
        ...
        if (reportedTotal > 0) {
            ...
            return ProgressUpdate(
                ...
                updatedEstimate = 0L, // total is known; no estimate needed
            )
        }

        // ── Case 2: total is unknown (-1) — estimate ──
