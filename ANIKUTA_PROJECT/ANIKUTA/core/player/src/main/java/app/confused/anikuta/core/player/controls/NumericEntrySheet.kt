 ...
 *
 * Ported from OLD `NumericKeypad.kt` (Task subtitle-settings-port). Removed the
 * experimental `useCustomKeypad` toggle and the OutlinedTextField fallback path
 * — the NEW project always uses the custom keypad (per spec).
 *
